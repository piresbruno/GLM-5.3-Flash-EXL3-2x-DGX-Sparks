#!/usr/bin/env python3
"""bench_prefix_cache.py — AB-PLAN prefix-cache bench for campaign R1.
...
Usage:
    python3 tests/bench_prefix_cache.py --label r1-bundle --out results/ab/r1-bundle
    python3 tests/bench_prefix_cache.py --label baseline --sessions 4 \
